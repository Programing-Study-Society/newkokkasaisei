...
public static class globalValue
{
    ...
    public static int[] buildingcos = new int[] { 11, 30, 60, 100, 200, 400, 1000, 5400, 28000, 50000 };//10階建て~(hotel,eigakan,byouin,gakkou,)
    public static string[] buildingstr = new string[]{"低木", "街灯", "家２", "ホテル", "映画館", "ビル２", "家３", "軍事基地", "博物館", "ブラックタワー"};
}
